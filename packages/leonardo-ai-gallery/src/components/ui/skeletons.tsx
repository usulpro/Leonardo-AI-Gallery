...
export const ImageSkeleton = ({ color }: { color?: string }) => {
  return (
    <div
      role="status"
      className="animate-pulse w-full h-full flex items-stretch justify-center"
    >
      <div className="flex flex-col gap-4 items-center justify-center w-full m-6 bg-gray-300 rounded dark:bg-gray-700">
        <svg
        ...
        <h4>Generation is in progress...</h4>
      </div>
    </div>
  );
};
...
export const SquareLoader = ({ color = 'gray' }: { color?: string }) => {
  return (
